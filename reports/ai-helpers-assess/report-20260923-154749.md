...
**Repository**: ai-helpers-upstream
**Path**: `/Users/kpais/kpais-workspace/agentready-eval-agentic-docs/ai-helpers-upstream`
**Branch**: `main` | **Commit**: `b3ec8bbc`
**Assessed**: September 23, 2026 at 3:47 PM
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **31.4/100** ⚠️ **Needs Improvement** ([Tier Definitions](https://ambient-code.github.io/agentready/attributes.html#tier-system)) |
| **Attributes Assessed** | 22/34 |
...
2. **CI Quality Gates** (Tier 1) - +5.0 points potential
...
5. **Dependency Security & Vulnerability Scanning** (Tier 1) - +5.0 points potential
...
- tests/: ✗
- Naming consistency: mixed conventions in images, images/repos, plugins/agentic-docs/skills/component-docs/templates (+1 more) (reduces glob-ability for agents)
...
![T1](https://img.shields.io/badge/T1-Dependency_Pinning_for_Reproducibility_N--A-lightgray) **Dependency Pinning for Reproducibility** ⊘ 
...
**Measured**: 8.6% (Threshold: ≥80%)

**Evidence**:
- Documented items: 7/81
- Coverage: 8.6%
...
![T2](https://img.shields.io/badge/T2-.gitignore_Completeness_75--100-green) **.gitignore Completeness** ✅ 75/100
...
![T3](https://img.shields.io/badge/T3-Lint_Suppression_Density_N--A-lightgray) **Lint Suppression Density** ⊘ 
...
- **Repository Snapshot**: b3ec8bbc4d7b947fd6f18dd13339d9acbb8c37ce
- **Assessment Duration**: 1.4s
- **Assessed By**: kpais@kpais-mac
- **Assessment Date**: September 23, 2026 at 3:47 PM
